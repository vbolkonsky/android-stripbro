package com.striphack.stripbro.ui.activity.base;
...
public final class ActivityNavigator {
    ...
    public static final String ARGS_BUNDLE = ".ui.activity.ARGS_BUNDLE";

    private static final Map<String, Activity> activityBuffer = new HashMap<>();
